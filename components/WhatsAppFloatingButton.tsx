  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end">
      ...
      <a
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-[#1EBE5B] hover:shadow-2xl active:scale-95"
      >
        <svg
          className="h-7 w-7 fill-white transition group-hover:rotate-6"
          viewBox="0 0 24 24"
