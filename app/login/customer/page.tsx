  ...
  return (
    <div className="w-full max-w-md rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-5 sm:p-6 shadow-xl">
      <div className="text-center">
        ...
        <h1 className="mt-2.5 text-xl sm:text-2xl font-black text-[#073B6F]">Customer Login</h1>
        ...
        <div>
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-10 pr-3 text-sm text-slate-800 outline-none focus:border-[#0B5FA5] focus:bg-white transition"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-10 pr-10 text-sm text-slate-800 outline-none focus:border-[#0B5FA5] focus:bg-white transition"
            />
            <button
              type="button"
      ...
      <div className="mt-4 pt-3.5 text-center text-xs text-slate-500 border-t border-slate-100">
